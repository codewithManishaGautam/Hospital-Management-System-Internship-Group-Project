...
const HealthIndiaForm = ({ patientData, mode }) => {
  const template = FORM_TEMPLATES.HEALTHINDIA_TPA;
  ...
  return (
    <BaseFormLayout
      ...
      pdfLink="HealthIndia_Cashless_Request.pdf"
      mode={mode}
      loading={loading}
...
export default HealthIndiaForm;
