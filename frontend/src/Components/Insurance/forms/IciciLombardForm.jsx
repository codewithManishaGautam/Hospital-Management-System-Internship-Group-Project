...
const IciciLombardForm = ({ patientData, mode }) => {
  const template = FORM_TEMPLATES.ICICI_LOMBARD;
  ...
  return (
    <BaseFormLayout
      ...
      pdfLink="ICICI_Lombard_Cashless_Form.pdf"
      mode={mode}
      loading={loading}
...
export default IciciLombardForm;
