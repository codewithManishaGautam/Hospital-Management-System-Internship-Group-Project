...
const BajajAllianzPgpClaimForm = ({ patientData, mode }) => {
  const template = FORM_TEMPLATES.BAJAJ_ALLIANZ_PGP_CLAIM;
  ...
  return (
    <BaseFormLayout
      title={template.name}
      subtitle="Global Personal Guard Policy Claim Form"
      pdfLink="Bajaj_Allianz_PGP_Claim_Form.pdf"
      mode={mode}
      loading={loading}
...
export default BajajAllianzPgpClaimForm;
